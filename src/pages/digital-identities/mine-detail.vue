        ...
        <div class="w-full h-full p-4">
            ...
            <div class="flex justify-between my-4 font-light">
                <div class="flex-1 flex">
                    ...
                    <span :title="company.iid" class="truncate w-[calc(29vw)] block overflow-hidden">{{ company.iid
                    }}</span>
                </div>
                <div class="flex-1 flex">
                    <span class="mr-4">数字身份公钥</span>
                    <span :title="company.publicKey" class="truncate w-[calc(29vw)] block overflow-hidden">
                        {{ company.publicKey }}
                    </span>
                </div>
            </div>
            ...
            <div v-if="company.authenticationType == '102'">
                ...
                <div class="flex justify-between my-4 font-light">
                    ...
                    <div class="flex-1">
                        ...
                        <img class="w-60 inline-block" :disabled="loading" @click="showDialogVisible('businessLicense')"
                            :src="company.businessLicense" alt="营业执照" />
                    </div>
                </div>
            </div>
            <div v-else>
                ...
                <div class="flex justify-between my-4 font-light">
                    <div class="flex-1">
                        ...
                        <img class="w-60 inline-block" :disabled="loading" @click="showDialogVisible('idPortrait')"
                            :src="company.idPortrait" alt="身份证人像面" />
                    </div>
                    <div class="flex-1">
                        <span class="mr-4 align-top">身份证国徽面</span>
                        <img class="w-60 h-60 inline-block" :disabled="loading" @click="showDialogVisible('idEmblem')"
                            :src="company.idEmblem" alt="身份证国徽面" />
                    </div>
                </div>
            </div>
        </div>
